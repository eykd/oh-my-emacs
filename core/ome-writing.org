                ...
                (lambda ()
                  (when buffer-file-name
                    (add-hook 'after-save-hook
                              ...
                              nil t)
                    (setq tab-width 2)
                    (local-set-key "\M-n"  (lambda () (interactive) (scroll-up   1)) )
                    (local-set-key "\M-p"  (lambda () (interactive) (scroll-down 1)) )
                    (local-set-key "\M-\S-n"  (lambda () (interactive) (scroll-up   5)) )
                    (local-set-key "\M-\S-p"  (lambda () (interactive) (scroll-down 5)) )
                    )
                  ))
        )
